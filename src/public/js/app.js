...
var _changeLogs = __webpack_require__(22);

var _changeLogs2 = _interopRequireDefault(_changeLogs);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

Vue.component('change-logs', _changeLogs2.default);
...
//theme
var $ = __webpack_require__(0)(window);
...
var _showdown = __webpack_require__(19);
...
exports.default = {
   ...
   * @return void
   */
		fetchChangeLogFile: function fetchChangeLogFile() {
			var _this = this;

			var vm = this;

			this.$http.get(this.getBranch()).then(function (response) {
				vm.raw = _this.toMarkdown(response.data);
			}, function (response) {
				return 'The branch ' + _this.version + ' does not exist!';
			});
		},
   ...
   * @return object
   */
		toMarkdown: function toMarkdown(response) {
...
if (__vue_script__ &&
  ...
  console.warn("[vue-loader] src/resources/assets/js/vue/components/changeLogs.vue: named exports in *.vue files are ignored.")}
